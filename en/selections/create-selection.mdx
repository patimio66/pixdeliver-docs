...
<Frame>
  <img src="/images/en/selections/selection-create.png" alt="Selection request creation form" />
</Frame>

<Frame>
  <img src="/images/en/selections/selections-list.png" alt="List of selection requests in a gallery" />
</Frame>
...
**Solution:**
- See the next section: [Sharing a selection](/en/selections/share-selection)
...
- [Sharing a selection](/en/selections/share-selection) - How to send the selection link to clients
- [Managing submissions](/en/selections/manage-submissions) - How to review your clients' selections
- [Creating a gallery](/en/managing-galleries/create-gallery) - First create and pay for a gallery
